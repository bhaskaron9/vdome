...
public class FileSender implements Runnable
{
    ...
    String from;
    ClientManager clientManager;
  FileSender(String file,Socket clientSock,ClientManager getclientManager,String To,String From)
  {
      fileName=file;
      to=To;
      from =From;
  ...
  public void run()
  {
        try {
            ...
            String message="bhaifilebhejo"+" "+to +" "+clientsock.getLocalAddress().toString();
