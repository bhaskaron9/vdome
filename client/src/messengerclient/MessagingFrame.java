...
public class MessagingFrame extends javax.swing.JFrame {
        ...
        but_video.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(MessagingFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    if(sFileName != "")
    {
    	FileSender pFileSend = new FileSender(sFileName,clientManager.getsocket(),clientManager,to,from);
    ...
    private void but_videoActionPerformed(java.awt.event.ActionEvent evt) throws LineUnavailableException {//GEN-FIRST:event_but_fileActionPerformed
        // TODO add your handling code here:
  System.out.println("started the audio");
  LVC1 lv1 = new LVC1(clientManager.getsocket(),clientManager,to,from);
  clientExecutor.execute(lv1);
